...
?>">
	...
	<div class="ws_basic_container">
		...
		<form method="post" action="<?php echo admin_url('options-general.php?page=menu_editor&noheader=1'); ?>" id='ws_main_form' name='ws_main_form'>
			...
			<input type="button" id='ws_save_menu' class="button-primary ws_main_button" value="Uložiť zmeny" />
		</form>

			<input type="button" id='ws_reset_menu' value="Vrátiť zmeny" class="button ws_main_button" />
			<input type="button" id='ws_load_menu' value="Defaultné menu" class="button ws_main_button" />
